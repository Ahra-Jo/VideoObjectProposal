...
lme_param.dimk = 10; % Projection dimension. This will decide the dimensionality of hte learned space.
...
lme_param.numsamples = 1000; % Number of samples to consider for gradient computation at each step
